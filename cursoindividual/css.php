...
<body>
  ...
  <path d="M12 8a4 4 0 1 1-8 0 4 4 0 0 1 8 0zM8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0zm0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13zm8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5zM3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8zm10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0zm-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zm9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707zM4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708z"/>
      ...
      <ul>
        <li class="li line on" onclick="padrao()"><img src="../img/CSS3_logo.svg.png" alt="css"> Conheça o CSS</li>
        <li class="li line1" onclick="line1()"><img src="../img/CSS3_logo.svg.png" alt="css"> Introdução ao CSS (Parte 1)
        </li>
        <li class="line2" onclick="line2()"><img src="../img/CSS3_logo.svg.png" alt="css"> Introdução ao CSS (Parte 2)</li>
        <li class="line3" onclick="line3()"><img src="../img/CSS3_logo.svg.png" alt="css"> CSS em linha</li>
        <li class="line4" onclick="line4()"><img src="../img/CSS3_logo.svg.png" alt="css"> CSS incorporado</li>
        <li class="line5" onclick="line5()"><img src="../img/CSS3_logo.svg.png" alt="css"> CSS externo</li>
        <li class="line6" onclick="line6()"><img src="../img/CSS3_logo.svg.png" alt="css"> Estilização de Texto</li>
        <li class="line7" onclick="line7()"><img src="../img/CSS3_logo.svg.png" alt="css"> Efeitos em Borda</li>
        <li class="line8" onclick="line8()"><img src="../img/CSS3_logo.svg.png" alt="css"> Cores</li>
        <li class="line9" onclick="line9()"><img src="../img/CSS3_logo.svg.png" alt="css"> Display Flex</li>
        <li class="line10" onclick="line10()"><img src="../img/CSS3_logo.svg.png" alt="css"> Display Grid</li>
        <li class="line11" onclick="line11()"><img src="../img/CSS3_logo.svg.png" alt="css"> Responsividade (Parte 1)</li>
        <li class="line12" onclick="line12()"><img src="../img/CSS3_logo.svg.png" alt="css"> Responsividade (Parte 2)</li>
        <li class="line13" onclick="line13()"><img src="../img/CSS3_logo.svg.png" alt="css"> Resumo do Curso</li>
      </ul>
    </nav>
    <div class="conteudo">
...
>
  ...
  />
          ...
          <div class="logo-header">
            <img src="../img/CSS3_logo.svg.png" alt="Logo CSS">
          </div>
        </div>
  ...
  <path fill-rule="evenodd" d="M12.5 15a.5.5 0 0 1-.5-.5v-13a.5.5 0 0 1 1 0v13a.5.5 0 0 1-.5.5ZM10 8a.5.5 0 0 1-.5.5H3.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L3.707 7.5H9.5a.5.5 0 0 1 .5.5Z"/>
      ...
      <main>
        ...
        <div class="aula2">
          <div class="titulo-barra">
            <div class="titulo-aulas">
              <h3>Introdução ao CSS (Parte 1)</h3>
              <hr class="linhas">
            </div>
            <div class="barra-progresso">
              <div class="progresso">
        ...
        <div class="aula3">
          ...
          <div class="titulo-barra">
            <div class="titulo-aulas">
              <h3>Introdução ao CSS (Parte 2)</h3>
              <hr class="linhas">
            </div>
            <div class="barra-progresso">
              <div class="progresso">
