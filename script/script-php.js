...
let fundoNav = document.querySelector('li.fundo')
const h1Titulo = document.getElementById('conteudo-titulo')
...
function aula1() {
  h1Titulo.innerHTML = 'História do PHP'
  ...
  descricao.innerHTML = 'Nessa aula estudamos sobre a história do PHP, aprendendo um pouco sobre seu fundador e todas as versões que iniciaram essa história. Também fizemos um acordo de como seguir assistindo os vídeos do curso.'
}

function aula2() {
  h1Titulo.innerHTML = 'Em Breve'
